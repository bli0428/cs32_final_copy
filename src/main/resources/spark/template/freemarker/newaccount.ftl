		...
		<div class="row">
			...
			<div class="form-group col-lg-8 offset-lg-2" style="margin-top:2%">
				<form role="form" method="POST" action="/newaccountresults">
					...
					<hr class="colorgraph">
					<div class="row">
						<div class="col-xs-12 col-md-6"><input id="submit" type="submit" value="Register" class="btn btn-success btn-block btn-lg" tabindex="7"></div>
						<div class="col-xs-12 col-md-6"><a href="/login" class="btn btn-primary btn-block btn-lg">Already have an account?</a></div>
					</div>
				</form>
			</div>
		</div>
