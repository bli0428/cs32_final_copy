...
//  private int[] requests;
  ...
  private int[][] pawnT = { { 0, 0, 0, 0, 0, 0, 0, 0 },
      ...
      { 5, -5, -10, 0, 0, -10, -5, 5 }, { 5, 10, 10, -20, -20, 10, 10, 5 },
      { 0, 0, 0, 0, 0, 0, 0, 0 } };

  private int[][] knightT = { { -50, -40, -30, -30, -30, -30, -40, -50 },
  ...
  private int[][] bishopT = { { -20, -10, -10, -10, -10, -10, -10, -20 },
  ...
  private int[][] rookT = { { 0, 0, 0, 0, 0, 0, 0, 0 },
  ...
  private void pieceSquare(Piece piece, Position position) {
    if (piece.color() == 0) {
      ...
      switch (type) {
      case "p":
        pieceSquareValue += pawnT[9 - position.row() - 1][9 - position.col()
            - 1];
        break;
      case "k":
        pieceSquareValue += knightT[9 - position.row() - 1][9 - position.col()
            - 1];
        break;
      case "b":
        pieceSquareValue += bishopT[9 - position.row() - 1][9 - position.col()
            - 1];
      case "r":
        pieceSquareValue += rookT[9 - position.row() - 1][9 - position.col()
            - 1];
      default:
        break;
      }
  ...
  public List<Double> evalBoard(Board board) {
    ...
    // System.out.println(String.format("pieceSquareValue is %d and new whiteVal
    // is %f", pieceSquareValue, whiteVal));
