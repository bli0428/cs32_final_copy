...
public final class GUI {
	...
	private static class HomeFrontHandler implements TemplateViewRoute {
		...
		public ModelAndView handle(Request req, Response res) {
			...
			Map<String, Object> variables = ImmutableMap.of("title", "Chess32: Home", "user",
					u.getUsername(repl.getDbm()), "content", GAME_LIST.printListHtml(), "message", "");
	...
	public static class ChessGameHandler implements TemplateViewRoute {
		...
		public ModelAndView handle(Request request, Response response)
			...
			String gameId = java.net.URLDecoder.decode(request.params(":something"), "UTF-8");
			Map<String, Object> variables = ImmutableMap.of("title", "CHESS GAME " + gameId, "gameId", gameId);
	...
	private static class ChessHandler implements TemplateViewRoute {
		...
		public ModelAndView handle(Request req, Response res) {
			...
			Map<String, Object> variables = ImmutableMap.of("title", "CHESS", "gameId", 99);
			return new ModelAndView(variables, "board.ftl");
		}
	}
	...
	private static class LoginFrontPageHandler implements TemplateViewRoute {
		...
		public ModelAndView handle(Request req, Response res) {
			...
			Map<String, Object> variables = ImmutableMap.of("title", "Chess32: Login", "message", "");
	...
	private static class NewAccountFrontHandler implements TemplateViewRoute {
		...
		public ModelAndView handle(Request req, Response res) {
			...
			Map<String, Object> variables = ImmutableMap.of("title", "Chess32: Create Account", "message", "");
	...
	public static class NewAccountResultsHandler implements TemplateViewRoute {
		...
		public ModelAndView handle(Request req, Response res) {
			...
			if (message != null) {
				Map<String, Object> variables = ImmutableMap.of("title", "Chess32: Create Account", "message", message);
				return new ModelAndView(variables, "newaccount.ftl");
			}
			Map<String, Object> variables = ImmutableMap.of("title", "Chess32: Login", "message",
					"New account created.");
	...
	private static class ChangePasswordFrontHandler implements TemplateViewRoute {
		...
		public ModelAndView handle(Request req, Response res) {
			...
			Map<String, Object> variables = ImmutableMap.of("title", "Chess32: Change Password", "message", "");
	...
	public static class ChangePasswordResultsHandler implements TemplateViewRoute {
		...
		public ModelAndView handle(Request req, Response res) {
			...
			Map<String, Object> variables = ImmutableMap.of("title", "Chess32: Home", "user", username, "message",
					"Password successfully updated.", "content", GAME_LIST.printListHtml());
			return new ModelAndView(variables, "home.ftl");
		}
	}
	...
	private static class ChangeUsernameFrontHandler implements TemplateViewRoute {
		...
		public ModelAndView handle(Request req, Response res) {
			...
			Map<String, Object> variables = ImmutableMap.of("title", "Chess32: Change Username", "message", "");
	...
	public static class ChangeUsernameResultsHandler implements TemplateViewRoute {
		...
		public ModelAndView handle(Request req, Response res) {
			...
			Map<String, Object> variables = ImmutableMap.of("title", "Chess32: Home", "user", newUsername, "message",
					"Username successfully updated.", "content", GAME_LIST.printListHtml());
			return new ModelAndView(variables, "home.ftl");
		}
	}
